...
public class BookStreamDropDown extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private onClickInterface onClickInterface;

    public BookStreamDropDown(Context context) {
        super(context);
        initView(context);
    }

    public BookStreamDropDown(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public BookStreamDropDown(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        listViewSort.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (onClickInterface != null)
                onClickInterface.onClickDone(model.getId());
            popupWindow.dismiss();
        });
    ...
    public class CustomAdapter extends ArrayAdapter<DataModel> implements OnClickListener {
        ...
        CustomAdapter(ArrayList<DataModel> data, Context context) {
            super(context, R.layout.filter_streamspinner_item, data);
            this.dataSet = data;
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.filter_streamspinner_item, parent, false);
