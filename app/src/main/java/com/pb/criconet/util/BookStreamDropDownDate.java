...
public class BookStreamDropDownDate extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private onClickInterface onClickInterface;

    public BookStreamDropDownDate(Context context) {
        super(context);
        initView(context);
    }

    public BookStreamDropDownDate(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public BookStreamDropDownDate(Context context, AttributeSet attrs, int defStyleAttr) {
