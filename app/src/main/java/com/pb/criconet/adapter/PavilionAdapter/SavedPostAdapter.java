...
public class SavedPostAdapter extends AAH_VideosAdapter {
    ...
    public SavedPostAdapter(Activity mcontext, ArrayList<NewPostModel> chatname_list1, PostListeners listeners) {
        context = mcontext;
