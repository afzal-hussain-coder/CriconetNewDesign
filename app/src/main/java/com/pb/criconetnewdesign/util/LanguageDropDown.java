...
public class LanguageDropDown extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {
    ...
    public LanguageDropDown(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public LanguageDropDown(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public class CustomAdapter extends ArrayAdapter<DataModel> implements OnClickListener {
        ...
        CustomAdapter(ArrayList<DataModel> data, Context context) {
            super(context, R.layout.language_spinner_item, data);
            this.dataSet = data;
