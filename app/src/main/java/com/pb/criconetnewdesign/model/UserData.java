...
import com.pb.criconetnewdesign.model.pavilionModel.NewUserModel;
...
public class UserData implements Parcelable {
    ...
    public Integer getTotal_completed_profile() {
        return total_completed_profile;
    }

    public void setTotal_completed_profile(Integer total_completed_profile) {
        this.total_completed_profile = total_completed_profile;
    }

    private Integer total_completed_profile;
    ...
    public static UserData fromJson(JSONObject jsonObject) {
        ...
        try {
            ...
            b.cricheroes_profile_link = jsonObject.getString("cricheroes_profile_link");
            b.total_completed_profile = jsonObject.optInt("total_completed_profile");
...
//            b.follow_request_users = NewUserModel.fromJson(Objects.requireNonNull(jsonObject.optJSONArray("follow_request_users")));
    ...
    private UserData(Parcel in) {
        ...
        this.cricheroes_profile_link = ((String) in.readValue((String.class.getClassLoader())));
        this.total_completed_profile = ((Integer) in.readValue((Integer.class.getClassLoader())));
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(vk);
        dest.writeValue(cricheroes_profile_link);
        dest.writeValue(total_completed_profile);
