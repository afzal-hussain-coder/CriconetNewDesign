...
package com.pb.criconetnewdesign.event.drawingPaint;
...
public class DrawingView extends View {
    ...
    public static final int ERAZER = 9;
    public static final float TOUCH_TOLERANCE = 4;
    public static final float TOUCH_STROKE_WIDTH = 12;
    ...
    private int mBrushColor=getResources().getColor(R.color.color_error_password);
...
//    private Paint mBitmapPaint = new Paint(Paint.DITHER_FLAG);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaintFinal.setColor(mBrushColor);
